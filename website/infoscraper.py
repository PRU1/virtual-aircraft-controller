'''
Given all the information about the position of the aircraft and the pilot commands, decide whether to fly or land the plane.
'''
import openai
import base64
import os
...
# Transcribe audio
def scrapeinfo(audio_file_path):
    audio_path = ""
